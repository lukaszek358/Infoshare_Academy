...
class School:
    ...
    def self_print_max_student_number(self):                       # FUNKCJA POMOCNICZA Z POZIOMU OBIEKTU (self)
        print(f' self MAX STUDENT NUMBER {self.MAX_STUDENTS_NUMBER}')
    @classmethod
    def cls_print_max_student_number(cls):                          # FUNKCJA POMOCNICZA Z POZIOMU KLASY (cls)
        print(f' cls MAX STUDENT NUMBER: {cls.MAX_STUDENTS_NUMBER}')
def run_example():
