...
# OBIEKT DANEJ KLASY ZAWIERA W SOBIE POLA OBIEKTU, KTÓRE SĄ TAKIMI 'WEWNĘTRZNYMI ZMIENNYMI'
# KAŻDEMU TAKIEMU POLU MOŻEMY PRZYPISAĆ JAKĄŚ WARTOŚĆ I DEFINICJE JAKIE BĘDĄ ROBIMY WEWNĄTRZ kONSTRUKTORA
# class Student:
#     def __init__(self):
#         self.first_name = 'Mikołaj'                                                                                     # POLE OBIKETU, DLA PRZYKŁADU: self.first_name JEST PEWNEGO RODZAJU ZMIENNĄ WEWNĄTRZ OBIEKTU
